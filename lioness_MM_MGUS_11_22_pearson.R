...
###############################################
### Pearson correlation between MM and MGUS ###
###############################################
...
hitGeneMM_MGUS <- geneppr$name[geneppr$name %in% b]
mylist <- hitGeneMM_MGUS 
write.table(mylist,"hitGeneMM_MGUS.txt",sep=",")
write.table(b,"GeneMM_MGUS.txt", sep = ",")
